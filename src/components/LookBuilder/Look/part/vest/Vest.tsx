...
import { VestIcon } from '../../../../icons/icons';
            ...
            {vest.name !== '' ? (
                <div className="selected-suits" onClick={handleClick}>
                    <div className="image-container">
                        <img className="left-image" src={vest.galery_url} alt="" style={{ width: '40px', height: '50px' }} />
                    </div>
                    <div className="right-container">
                        <div className="right-top">
                            <div className="suit-wrapper">
                                <div className="suit-name">{vest.name}</div>
                        ...
                        <div className="right-bottom">
                            ...
                            <div className="suit-price">{vest.price}</div>
                        </div>
                    </div>
                </div>
            ) : (
                <div className="unselected-suits" onClick={handleClick}>
                    ...
                    <div className="unselected-right">
                        <div className="suit-kind">Vest</div>
