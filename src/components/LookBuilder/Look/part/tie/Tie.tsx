...
import { TieIcon } from '../../../../icons/icons';
            ...
            {tie.name !== '' ? (
                <div className="selected-suits" onClick={handleClick}>
                    <div className="image-container">
                        <img className="left-image" src={tie.galery_url} alt="" style={{ width: '40px', height: '50px' }} />
                    </div>
                    <div className="right-container">
                        <div className="right-top">
                            <div className="suit-wrapper">
                                <div className="suit-name">{tie.name}</div>
                        ...
                        <div className="right-bottom">
                            ...
                            <div className="suit-price">{tie.price}</div>
                        </div>
                    </div>
                </div>
            ) : (
