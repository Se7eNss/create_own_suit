...
export const Pocket = () =>{
    return(
        <svg width="17" height="17" class="IconBase-sc-1eb9083-0 eRtcHV" viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="none"><title>Pocket Square Icon</title><svg viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg" fill="none"><title>Pocket Square Icon</title><path d="M12.5282 4.4736l1.7894 1.7895L16.5545 8.5l-8.0527 8.0526L.4492 8.4999l2.2369-2.2368 1.7894-1.7895" stroke="#9a6700"></path><path d="M2.6836 6.263L8.4994.4474l5.8158 5.8158M2.6836 6.2632h11.6316M14.3152 6.2632L8.4994 12.079 2.6836 6.2632" stroke="#9a6700"></path></svg></svg>
        )
}
export const LabelPin = () =>{
    return(
        <svg width="14" height="14" class="IconBase-sc-1eb9083-0 eRtcHV" viewBox="0 0 14 14" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="none"><title>Lapel Pin Icon</title><path d="M9.222 7.0001c-.7412 1.5647-2.306 2.6353-4.2 2.6353-2.553 0-4.6118-2.0588-4.6118-4.6118C.4102 2.4706 2.469.412 5.0219.412c.6589 0 1.2353.1647 1.8118.3294" stroke="#9a6700"></path><path d="M6.9986 9.2236c-1.5647-.7411-2.6353-2.3058-2.6353-4.2C4.3633 2.4706 6.422.412 8.975.412c2.553 0 4.6118 2.0588 4.6118 4.6117 0 .6589-.1647 1.2353-.3294 1.8118" stroke="#9a6700"></path><path d="M6.9984 4.7764c1.5647.7411 2.6353 2.3059 2.6353 4.2 0 2.5529-2.0588 4.6117-4.6118 4.6117-2.553 0-4.6117-2.0588-4.6117-4.6117 0-.7412.1647-1.4.4117-1.9765" stroke="#9a6700"></path><path d="M4.8594 7c.7412-1.5647 2.3059-2.6353 4.1176-2.6353 2.553 0 4.6118 2.0589 4.6118 4.6118 0 2.553-2.0588 4.6118-4.6118 4.6118-.7412 0-1.4-.1647-1.9765-.4118" stroke="#9a6700"></path></svg>
        )
}
export const Cufflinks = () =>{
    return(
...
export const Shoe = () =>{
    return(
        <svg width="22" height="11" class="IconBase-sc-1eb9083-0 eRtcHV" viewBox="0 0 22 11" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="none"><title>Shoe Icon</title><path d="M13.5999 4.4802l-.6413 1.4964-3.4915.7125-1.8526 1.2826H1.914M10.0384 2.6277L8.6133 3.9815" stroke="#9a6700"></path><path d="M1.6307 3.0552L1.203 9.967H7.83V8.5419l5.6291 1.425 7.3393-.855-.0713-.9263c-.0712-.9263-.6413-1.7814-1.5676-2.0664l-5.6291-1.7101-4.7029-3.2777-.855.7125C6.5472 3.0552 4.6946 3.4828 2.9132 3.269l-1.2825-.2138zM11.4642 3.34l-1.4251 1.354" stroke="#9a6700"></path></svg>
        )
}
export const Sock = () =>{
    return(
        <svg width="15" height="18" class="IconBase-sc-1eb9083-0 eRtcHV" viewBox="0 0 15 18" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="none"><title>Socks Icon</title><path d="M9.0003 13.3364l-2.8636.5728M10.7188 3.1091h-4.5M6.2199 3.1091H.6563M13.9105 13.3364l-2.8636.5728M.4102.4092h5.809v8.7545l2.3728 2.7818c.7363.8182 1.1454 1.9637 1.1454 3.0273 0 1.4727-1.1454 2.6182-2.6181 2.6182-1.0637 0-2.0455-.4909-2.6182-1.3091L.492 11.0455.4102.4092z" stroke="#9a6700"></path><path d="M5.3164.4092h5.4818v8.7545l2.3728 2.7818c.7363.8182 1.1454 1.9637 1.1454 3.0273 0 1.4727-1.1454 2.6182-2.6182 2.6182-.7363 0-1.4727-.3273-1.9636-.9" stroke="#9a6700"></path></svg>
        )
}